...
@Autonomous(name="Back_Autonomous_IMU")
public class Back_Autonomous_IMU extends LinearOpMode{
    ...
    double globalAngle;
      ...
      /*     MotorsForward();
        ...
        public void ImuGyroTurn(double power, int targetAngle, int safetyNet) {
            getAngle();
       ...
       public void CheckGyroValues() {
        ...
        public void WayToCryptobox(){
            if(StoneColor == blue){
                ...
                StopDriving();
                sleep(500);
                ImuGyroTurn(.3,-90,3);//target angle:90
                StopDriving();
                sleep(500);
                ...
                StopDriving();
                sleep(250);
                ForwardByRotations(.3,1.2);
                StopDriving();
                sleep(250);
                LiftGlyph2();
                StopDriving();
                sleep(500);
                ImuGyroTurn(.3,90,4);//target angle:90
                StopDriving();
                sleep(500);
            }
        }
