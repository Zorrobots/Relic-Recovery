package org.firstinspires.ftc.teamcode.RelicRecovery.Autonomous.Auto_55;
 ...
 */
//@Autonomous(name="Back_Autonomous_55")
public class Back_Autonomous_55 extends LinearOpMode {
    //WHEELS
    ...
    protected DcMotor GlyphGrabberR = null;
    protected DcMotor GlyphGrabberL = null;
    ...
    protected void GrabGlyph(double power, int wait){
    ...
    protected void DropGlyph(double power, int wait){
        GlyphGrabberR.setPower(-power);
        GlyphGrabberL.setPower(-power);
        sleep(wait);
        GlyphGrabberR.setPower(0);
    ...
    protected void TurnToCryptobox () {
