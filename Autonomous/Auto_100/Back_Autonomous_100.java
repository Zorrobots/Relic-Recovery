package org.firstinspires.ftc.teamcode.RelicRecovery.Autonomous.Auto_100;
 ...
 */
@Autonomous(name="Back_Autonomous_100")
public class Back_Autonomous_100 extends LinearOpMode{
    ...
    public void WayToCryptobox(){
        if(StoneColor == blue){
            ...
            StopDriving();
            sleep(500);
            TurnToCryptoboxRed(.3,90,3);//target angle:90
            StopDriving();
            sleep(500);
        }
    }
    public void PlaceGlyphOnCryptobox(){
        StopDriving();sleep(150);
        ReverseByTime(.15,200);
        TakeDownGlyph();
        if (StoneColor == blue && Multi == "LEFT") {
            TurnToCryptoboxBlue(.3, -110, 2);
        }
        else if(StoneColor == blue && Multi == "CENTER"){
            TurnToCryptoboxBlue(.3,-90,2);
        }
        else if ( StoneColor == blue && Multi == "RIGHT"){
            TurnToCryptoboxBlue(.3,-75,3);
        }
        else if (StoneColor == red && Multi == "LEFT") {
            TurnToCryptoboxRed(.3, 75, 3);
        }
        else if(StoneColor == red && Multi == "CENTER"){
            TurnToCryptoboxRed(.3,90,3);
        }
        else if ( StoneColor == red && Multi == "RIGHT"){
            TurnToCryptoboxRed(.3,110,3);
        }
        else   {
