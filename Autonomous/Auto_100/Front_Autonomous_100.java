 ...
 */
@Autonomous(name="Front_Autonomous_100")
public class Front_Autonomous_100 extends LinearOpMode{
    ...
    public void WayToCryptobox(){
        if(StoneColor == blue){
            ...
            StopDriving();
            sleep(500);
            TurnToCryptoboxBlue(.3,90,3);//target angle:90
            StopDriving();
            sleep(500);
